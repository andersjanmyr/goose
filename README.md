...
* [OS X](https://github.com/andersjanmyr/goose/releases/download/v1.3.0/goose-osx)
* [Linux](https://github.com/andersjanmyr/goose/releases/download/v1.3.0/goose-linux)
* [Windows](https://github.com/andersjanmyr/goose/releases/download/v1.3.0/goose.exe)
...
```
# OS X
$ curl https://github.com/andersjanmyr/goose/releases/download/v1.3.0/goose-osx \
  > /usr/local/bin/goose

# Linux
$ curl https://github.com/andersjanmyr/goose/releases/download/v1.3.0/goose-linux \
  > /usr/local/bin/goose
