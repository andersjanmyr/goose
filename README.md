...
* [OS X](https://github.com/andersjanmyr/goose/releases/download/1.4.0/goose-osx)
* [Linux](https://github.com/andersjanmyr/goose/releases/download/1.4.0/goose-linux)
* [Windows](https://github.com/andersjanmyr/goose/releases/download/1.4.0/goose.exe)
* [Bash completion](https://raw.githubusercontent.com/andersjanmyr/goose/1.4.0/goose_completion.sh)

### Curl

```
# OS X
$ curl -L https://github.com/andersjanmyr/goose/releases/download/1.4.0/goose-osx \
  > /usr/local/bin/goose

# Linux
$ curl -L https://github.com/andersjanmyr/goose/releases/download/1.4.0/goose-linux \
  > /usr/local/bin/goose
